    ...
    <div className="ip-panel">
      ...
      <div className="ip-slider-card">
        ...
        <p className="ip-context">
          ...
          {data.inCapi
            ? ` · ${data.yearsInPayg} ans en répartition + ${data.yearsInCapi} ans en capitalisation`
      ...
      {data.inCapi && data.yearsInPayg > 0 && (
        <p className="ip-pot">
          Cohorte de transition&nbsp;: vos {data.yearsInPayg}&nbsp;ans de
          cotisations PAYG accumulées avant la réforme génèrent une pension
      ...
      <p className="ip-disclaimer">
        Projection pédagogique d’un salarié médian (cotisation à partir de
        22&nbsp;ans → âge légal). La trajectoire « sans réforme » suppose
        que l’État peut servir les pensions dues — ce que la dette montre
        comme irréaliste à long terme. Voir l’onglet Hypothèses.
      </p>
    </div>
  )
}
