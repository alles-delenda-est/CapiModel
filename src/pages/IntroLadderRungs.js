...
export const LADDER_RUNGS = [
  ...
  },
  {
    ...
    summary: "Le rééquilibrage proposé par Équinoxe réduit progressivement les retraites élevées, supprime l'abattement de 10 %, et restaure la CSG/CRDS à taux plein, sans toucher aux petites retraites. Cela réduit le trou annuel et repousse nettement l'échéance — mais ne l'annule pas : les retraites restent structurellement dépendantes des transferts du budget général et de la démographie, et la dette (héritée + nouvelle) continue de s'accumuler jusqu'au mur : dans le modèle, la restructuration forcée intervient vers 2072, contre ~2059 sans réforme. Une douzaine d'années gagnées — précieuses — mais pas un retour à l'équilibre.",
  ...
  },
  {
    ...
    summary: [
      "La bascule « à la chilienne » : les actifs de moins de 50 ans passent en capitalisation, leurs droits déjà acquis dans l'ancien système sont reconnus explicitement (obligations de reconnaissance), et leurs cotisations alimentent désormais leur propre fonds. Le déficit de transition qui en résulte est affiché honnêtement comme dette publique (pic ~1 280 Md€ vers 2065, soit ~18 % du PIB de l'époque). Les transferts du budget général déjà existants (CSG, FSV, TVA ≈ 40 Md€/an) continuent de couvrir une partie du solde. La dette restante est remboursée par un prélèvement de 2,5 %/an sur le fonds capitalisé",
      { fn: 'fn_tauk' },
      ", prélevé sur la croissance du fonds de capitalisation ainsi créé et jamais sur la santé, l'éducation, et la justice, au-delà du plancher de solvabilité — les retraites ne sont jamais amputées. La dette est soldée vers 2074 et le fonds reste autonome jusqu'à la fin de l'horizon.",
    ],
