...
const TIPS = {
  ...
  cutoffAge: "Âge maximum en 2027 pour intégrer le système de retraite par capitalisation. « Aucun » = bascule universelle.",
  ...
  enableCapi: "Active le système de retraite par capitalisation (sinon : 100% PAYG).",
