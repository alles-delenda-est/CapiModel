...
describe('module scaffold', () => {
  ...
  it('exports LIFE_EXP_INDEXATION_FRACTION = 0.92', () => {
    expect(LIFE_EXP_INDEXATION_FRACTION).toBe(0.92);
  });
});
...
describe('retirementAge §5.4 eq (12)', () => {
  ...
  it('indexed mode: A_R(t=10) = base + 10/10 × 0.91 × 0.92 = 64.8372', () => {
    const cfg = { ...DEFAULT_CONFIG, retirementAgeMode: 'indexed' };
    expect(retirementAge(10, cfg)).toBeCloseTo(64.8372, 12);
  });
